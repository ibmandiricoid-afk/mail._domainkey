...
export const TerminalTab: React.FC<TerminalTabProps> = React.memo(({ 
  ...
  return (
    <motion.div
      ...
      className="px-2 sm:px-4 md:px-6 py-2.5 sm:py-4 w-full max-w-7xl mx-auto flex flex-col items-center justify-center"
    >
      <div className="bg-white rounded-2xl border border-slate-200 shadow-[0_12px_36px_-6px_rgba(15,23,42,0.12)] flex flex-col h-[580px] overflow-hidden w-full max-w-4xl">
        {/* Header Bar */}
        <div className="p-3.5 border-b border-slate-200 flex flex-wrap sm:flex-nowrap justify-between items-center bg-slate-100/80 gap-2">
          <div className="flex flex-col">
            ...
            <div className="flex items-center gap-1.5 mt-0.5">
              ...
              <span className="text-[9px] text-[#005291] font-bold uppercase tracking-wider">
          ...
          <div className="flex items-center gap-2 flex-wrap sm:flex-nowrap">
            ...
            <button
              ...
              className={hn(
                "px-2.5 py-1.5 rounded-full flex items-center gap-1.5 text-[10px] font-extrabold transition-all border cursor-pointer shrink-0 active:scale-95 shadow-xs",
                isAutoCollapse
                  ? "bg-indigo-900 text-indigo-200 border-indigo-700 hover:bg-indigo-800"
                  : "bg-slate-200 text-slate-700 border-slate-300 hover:bg-slate-300"
              )}
              title={isAutoCollapse ? "Mode Ringkas Aktif (Semua log latar belakang diringkas otomatis)" : "Mode Ringkas Mati (Menampilkan log penuh)"}
            >
            ...
            <button
              ...
              disabled={isTesting}
              className={hn(
                "w-8 h-8 rounded-full flex items-center justify-center transition-all border cursor-pointer active:scale-95 shadow-xs shrink-0",
                isTesting
            ...
            <button
              ...
              className="px-2.5 py-1.5 rounded-full bg-rose-50 hover:bg-rose-100 text-rose-600 border border-rose-200 hover:border-rose-300 transition-all flex items-center gap-1.5 text-[10px] font-extrabold cursor-pointer active:scale-95 shrink-0 shadow-xs"
        ...
        {/* Terminal Output */}
        <div className="p-4 flex-1 overflow-y-auto space-y-2 font-mono text-[11px] no-scrollbar relative bg-slate-900 text-slate-100">
